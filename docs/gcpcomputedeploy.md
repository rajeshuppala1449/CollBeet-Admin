 ...
 **WooHoo!!** CollBeet Admin is now up and running on GCP Cloud. 
 
You can either keep using External IP of your server or setup HTTPs using a custom domain with SSL for your deployed app on GCE. You can refer to this video, to setup a SSL Encrypted Custom Domain:- [Video](https://www.youtube.com/watch?v=eXtqqofrhOo) or [Alternate Video](https://www.youtube.com/watch?v=4iciq0ck8Ns). When you setup a custom domain, it will not start working immediately and may take upto 48 hours.
